  ...
  <div class="container">
    <div class="row">
      <div class="col-md-10 offset-md-1 text-white text-center">
        <h4>Search for Your favourite {{ $subcategory->category->name }} Projects</h4>
        <div class="row">
        ...
        <div class="row">
          <div class="container-fluid col-md-12 col-lg-8 offset-lg-2 mt-3">
            <form action="{{ route('projects.subcategory',$subcategory->id) }}" method="GET">
  ...
  <div class="row">
    ...
    <div class="col-lg-3 col-sm-6 mb-3">
      <div class="card">
        ...
        <hr>
        <div class="card-body">
          <a href="{{ route('buyer.single.post',$post->id) }}" class="card-link btn btn-info">View Detail</a>
          <a href="#" class="card-link btn btn-warning">Add to cart</a>
        </div>
      </div>
    </div>
    @empty
    <h3 class="text-center">No {{ $subcategory->name }} Projects Yet.</h3>
    @endforelse
  </div>
</div>
@endsection